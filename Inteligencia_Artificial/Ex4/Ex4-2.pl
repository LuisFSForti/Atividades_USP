...
:- consult('Ex4-1.pl').
% Para incluir o aluno "Carlos Silva" do arquivo anterior
:- multifile aluno/11.

aluno("Carlos Forti", "Rua das Orquideas, 32", "016966666666", "05/05/1955", 10,10,10,10,4,8,100).
...
?- situacao_sem_rec(Nome, reprovado).
Nome = "Matias Luzes".

% f)

?- situacao_sem_rec(Nome, aprovado).
Nome = "Carlos Silva" ;
Nome = "Carlos Forti" ;
Nome = "Mari Pereira" ;
Nome = "Joao Barrosa" .
