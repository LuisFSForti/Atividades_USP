...
//gcc -fopenmp -O3 -march=native studentsseq.c -o studentsseq -lm
...
//Este trecho é importante para a versão paralela
//Para fins de comparar o mesmo algoritmo, ele está presente também aqui, embora seja inútil
